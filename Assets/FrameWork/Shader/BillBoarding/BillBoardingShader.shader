Shader "GameEffect/BillBoardingShader"
{
    Properties
    {
        ...
        pass
        {
            ...
            vertexOutput Vertex(appdata_base i)
            {
                ...
                */
                ...
                /*把摄像机的位置转换到模型空间*/
                float3 viewer = mul(unity_WorldToObject, float4(_WorldSpaceCameraPos, 1)).xyz;//mul 矩阵右乘
                ...
                //顶点坐标旋转
                float3 centerOffset = i.vertex.xyz - center;
